  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(249, 115, 22, 0.08) 0%, #FAFAF9 50%, rgba(249, 115, 22, 0.05) 100%)",
        }}
      />

      <Header scrolled={scrolled} menuOpen={menuOpen} onToggleMenu={toggleMenu} />
